...
impl Qwen3GenerateModel {
    ...
    pub fn generate(&mut self, mes: ChatCompletionParameters, cancel_flag: Option<Arc<AtomicBool>>, ignore_list: Option<&[String]>, semantic_target: Option<&str>) -> Result<String> {
        let temperature = mes
            .temperature
