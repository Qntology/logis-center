...
function normalizeNumericHomoglyphs(str) {
    ...
    const map = {
        // 0: 영문 O, o, 그리스어 오미크론, 전각 문자, 기호 ○ 등
        'O': '0', 'o': '0', 'Ο': '0', 'ο': '0', '○': '0', '〇': '0', '０': '0', 'Ｏ': '0', 'ｏ': '0', 'D': '0',
        // 1: 영문 I, l, 전각, 파이프, 그리스어 요타 등
        'I': '1', 'l': '1', '１': '1', 'Ｉ': '1', 'ｌ': '1', 'Ι': '1', 'ι': '1', '|': '1', 'ᛁ': '1', '!': '1',
        // 2: 영문 Z, z, 전각, 뒤집힌 S 등
        'Z': '2', 'z': '2', '２': '2', 'Ƨ': '2', 'ᒿ': '2', 'Ƶ': '2', 'ᘔ': '2',
        // 3: 그리스어 제타(З), 에psilon(Ɛ) 등
        'Ɛ': '3', 'ɜ': '3', 'З': '3', 'з': '3', '３': '3', 'Ʒ': '3', 'Ƹ': '3',
        // 4: 나바호어 Ꮞ 등
        'Ꮞ': '4', '４': '4', 'ɥ': '4',
        // 5: 영문 S, s, 전각, 기호 등
        'S': '5', 's': '5', '５': '5', 'ƽ': '5', '$': '5', '§': '5',
        ...
        // 7: 영문 T, 전각 등
        'T': '7', '７': '7', 'т': '7', 'τ': '7',
        // 8: 그리스어 베타(Β), 독일어 ß, 영문 대문자 B, 전각 등
        'B': '8', 'Β': '8', 'β': '8', 'ß': '8', '８': '8', 'θ': '8', '∞': '8', '&': '8',
        // 9: 영문 g, q, 전각, 그리스어 q 등
        'g': '9', 'q': '9', '９': '9', 'ǵ': '9', 'ɡ': '9', 'q': '9', 'P': '9'
    };

    // 정규식 생성 시 특수 문자 이스케이프 처리
